...
namespace RSSReader.Tests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        [TestMethod]
        public void LoginPostRedirectsFeedIfLoginSuccessfulButNoReturnUrlGiven()
        {
            // Arrange
            AccountController controller = GetAccountController();
            ...
            // Assert
            Assert.AreEqual("Feed", result.RouteValues["controller"]);
        ...
        [TestMethod]
        public void RegisterPostRedirectsFeedIfRegistrationSuccessful()
        {
            // Arrange
            AccountController controller = GetAccountController();
